...
Surfaces = (function() {
  var Animation, Animations, Collision, Collisions, Element, Elements, Pattern, Patterns, Surface, _;

  _ = window["_"];

  Surfaces.regMap = function(reg, str, iterate) {
    var arr, matches;
    arr = [];
    while (true) {
  ...
  Surfaces.range = function(head) {
    var aplys, regHead, rjcts;
    regHead = /(\!)?(\d+)(?:\-(\d+))?\,?/g;
    rjcts = [];
    aplys = [];
    Surfaces.regMap(regHead, head, function(_arg) {
      var a, b, c, flag, nums, start, stop, __, _i, _results;
      __ = _arg[0], a = _arg[1], b = _arg[2], c = _arg[3];
      flag = a === void 0;
      start = Number(b);
      stop = Number(c);
  ...
  function Surfaces(text) {
    var regApnd, regComment, regDef, regOldIntvl, regOldPtn;
    regDef = /([^\{\}]+)\{([^\{\}]+)\}/g;
    ...
    this._defAry = [];
    this._apdAry = [];
    Surfaces.regMap(regComment, text, function(_arg) {
      var match;
      match = _arg[0];
      return text = text.replace(match, "");
    });
    Surfaces.regMap(regOldIntvl, text, function(_arg) {
    ...
    Surfaces.regMap(regOldPtn, text, function(_arg) {
    ...
    Surfaces.regMap(regDef, text, (function(_this) {
  ...
  Collisions = (function() {
    ...
    function Collisions(body) {
      ...
      Surfaces.regMap(reg, body, (function(_this) {
        return function(_arg) {
  ...
  Patterns = (function() {
    ...
    function Patterns(body) {
      Surfaces.regMap(ptnReg, body, (function(_this) {
        return function(_arg) {
  ...
  Animations = (function() {
    ...
    function Animations(body) {
      ...
      anmN = {};
      Surfaces.regMap(reg, body, function(_arg) {
        var n, str, __;
